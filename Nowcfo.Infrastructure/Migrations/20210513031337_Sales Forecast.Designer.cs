...
namespace Nowcfo.Infrastructure.Migrations
{
    ...
    [Migration("20210513031337_Sales Forecast")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.AllocationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.CogsType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.CompensationHistorical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CompensationHistorical");
                });
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.EmployeePermission", b =>
                {
                    ...
                    b.HasIndex("EmployeeId", "LevelOne", "LevelTwo", "LevelThree", "ReferenceId")
                        .IsUnique();

                    b.ToTable("EmployeePermissions");
                });

            modelBuilder.Entity("Nowcfo.Domain.Models.EmployeeStatusHistorical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmployeeStatusHistorical");
                });
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.JobRoleHistorical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("JobRoleHistorical");
                });

            modelBuilder.Entity("Nowcfo.Domain.Models.MarketAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MarketAllocation");
                });

            modelBuilder.Entity("Nowcfo.Domain.Models.MarketMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.OtherType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.PayTypeHistorical", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.SalesForecast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("BuyOuts")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("ClosedPayPeriods")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("Cogs")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal>("CogsQkly")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<decimal>("OtherPercent")
                        .HasColumnType("decimal(18,4)");

                    b.Property<DateTime>("PayPeriod")
                        .HasColumnType("datetime2");

                    b.Property<decimal>("Placements")
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.MarketAllocation", b =>
                {
                    b.HasOne("Nowcfo.Domain.Models.MarketMaster", "MarketMaster")
                        .WithMany("MarketAllocations")
                        .HasForeignKey("MasterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("MarketMaster");
                });
            ...
            modelBuilder.Entity("Nowcfo.Domain.Models.MarketMaster", b =>
                {
                    b.Navigation("MarketAllocations");
                });
